...
set mouse=a
set runtimepath=~/.vim,~/.vim/bundle/table-mode,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set showmatch
set softtabstop=4
set tabstop=4
...
exe 'vert 3resize ' . ((&columns * 126 + 118) / 237)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let s:l = 118 - ((26 * winheight(0) + 13) / 27)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 90 - ((25 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 98 - ((53 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
98
